...
//! that reads the active account's list. This module re-exports that
...
//!
//! [`active_account_demand`] is an ordinary [`crate::Demand`], so the read is
//! an ordinary [`crate::LiveQuery`]; no observation handle, frame proof or
//! qualified "observed" wrapper exists here to project.

pub use nmp_nip51::{
    active_account_demand, parse_simple_groups_list_from_raw_tags_tolerant,
