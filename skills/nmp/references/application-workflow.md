...
6. Bind query, content-session, signer-session, engine teardown, and receipt-observation tasks to deterministic owners. Cancelling receipt observation does not cancel a durable write obligation.
