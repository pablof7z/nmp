//! Minimal scripted HTTP/1.1 test double for the composition seam's
//! async upload-stage falsifiers (`composition.rs`, #559) -- the exact
//! shape reused from `crates/nmp-blossom/tests/support/mod.rs`.
//! CRITICAL (#538 lesson): the mock reads the FULL request
