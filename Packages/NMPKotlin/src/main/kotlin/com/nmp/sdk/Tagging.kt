...
internal fun Row.toFfi(): FfiRow =
    FfiRow(id, pubkey, createdAt, kind, tags, content, signature.toFfi(), sources)
 ...
 * boundary. Every input here is the decoded form: [Person.pubkey] is 64-char
 * hex like every other key in this package, and [Quote] names the [Row] the
 * app is already holding. The
