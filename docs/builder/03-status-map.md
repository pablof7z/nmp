...
| Protocol modules | `nmp-nip29` exposes tolerant reading of NIP-51 kind:10009 as part of NMP's remembered-group product capability and owns the exact NIP-29 host-scoped group operations; durable list mutation remains queued | [#1384](https://github.com/pablof7z/nmp/issues/1384), [#1552](https://github.com/pablof7z/nmp/issues/1552) |
