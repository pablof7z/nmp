...
pub struct PreparedReplaceableMaterialization {
    pub call: ReplaceableMaterializationCall,
    pub continuation: ReplaceableMaterializationContinuation,
}

pub struct ReplaceableMaterializationCall {
...
pub struct ReplaceableMaterializationContinuation {
