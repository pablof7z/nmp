...
Open gaps tracked honestly in [`docs/known-gaps.md`](docs/known-gaps.md) — most important: **account switching is reads-only** (signer is fixed; publishing as a switched account must be wired before M5's multi-nsec falsifier).
