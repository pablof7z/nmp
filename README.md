...
- ✅ **Replaceable delivery coalescing** — a newer kind `0`, `3`, `10000...19999`, or same-`d` `30000...39999` write atomically retires older offline work before its first wire attempt, retaining a typed `Superseded` receipt instead of replaying obsolete bytes
