...
use nmp_store::{
    ...
    GcRetentionSet, InsertOutcome, IntentId, PersistenceError, PersistenceFault, PromoteOutcome,
    ...
    PublishQueueRouteRevision, PublishQueueTransientCause, RelayObserved, RetractReason,
    StoredEvent,
};
