...
//! `crate::nip29`) because this core-level test must run without depending
//! on `nmp-nip02` (#1707 moved NIP-02's write door out of this crate
//! entirely) and regardless of which protocol features are enabled. The
